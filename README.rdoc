...
* Video support. NextGEN Enhancer can automatically detect video files
...
1. Check and set the default copyright message on the options page. This
   ...
   use is optional, but more on that under 4.
...
To turn this option on, check the 'Video support' checkbox on the options page.
...
* For each matching file, the link for the thumbnail when viewing a gallery
  ...
  JW Player and Flowplayer, but only using Lightview to view the gallery, so this
  may or may not work for you at all.
